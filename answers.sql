...
SELECT models.name AS model_name, brands.name AS brand_name, brands.headquarters AS headquarters FROM models JOIN brands USING (brand_id) WHERE models.name = 'Mustang';
...
SELECT COUNT(model_id) AS count FROM models WHERE brand_id = 'for';
...
SELECT models.year AS year, models.name AS name, models.model_id AS model_id, awards.name AS name 
FROM models LEFT JOIN awards
ON awards.winner_id = models.model_id
...
SELECT brands.name AS name, brands.founded AS year FROM brands
...
SELECT models.name as name, models.year as year FROM models
